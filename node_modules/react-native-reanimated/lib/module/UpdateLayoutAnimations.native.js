...
export const updateLayoutAnimations = (viewTag, type, config, isUnmounting, sharedTransitionTag) => updateLayoutAnimationsManager.update({
  viewTag,
  type,
  config: config ? createSerializable(config) : undefined,
  sharedTransitionTag
}, isUnmounting);
//# sourceMappingURL=UpdateLayoutAnimations.native.js.map